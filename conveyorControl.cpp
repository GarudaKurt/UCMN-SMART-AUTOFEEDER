...
// We need to move forward every 1 second (for manure)
...
//We need to reverse every 5 seconds
...
void conveyorStop() {
  if (millis() - conveyorStartTime >= 10000) {  // Stops after 10 seconds
